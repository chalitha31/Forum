...
console.log(signForm.style.top)
console.log(signbtn)
...
// window.addEventListener('load', (e) => { resizeWindow(700) })
// window.addEventListener('resize', (e) => { resizeWindow(700) })

function resizeWindow(width) {
    let paddingDefVal = 100;
    if (window.innerWidth < width) {
        let paddingVal = paddingDefVal - (width - window.innerWidth) / 7
