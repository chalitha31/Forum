    ...
    <header>
            ...
            <div class="header-searchbar-con">
                ...
                <select name="" id="serchC" class="cat-selector">
                    ...
                    ?>
                            ...
                            <option value="<?php echo $TrCtPostdata["id"] ?>"><?php echo $TrCtPostdata["name"] ?></option>
        ...
        <div class="header-right">
            ...
            ?>
                ...
                <i style="display: none;" class="fa-solid fa-comment-dots create-post-icon"></i>
                ...
                <div class="header-dropdown-container">
                    <div class="header-dropdown-user-container">
                        <div class="header-dropdown-user-img-holder">
                            ...
                            ?>
                                <img onclick="userprofile('<?php echo $_SESSION['user_email'] ?>');" src="./images/header/forum-user-img.avif" alt="user" class="view-user-pic">
                            <?php
                            }
                    ...
                    <div class="header-dropdown-feature-container">
                        <div class="header-dropdown-feature-container-one">
                            ...
                            ?>
                                    ...
                                    <i class="fa-solid fa-user-tie highlight-red"></i>
                                    <li onclick="adminlog();" class="header-dropdown-my-content highlight-red">Admin</li>
